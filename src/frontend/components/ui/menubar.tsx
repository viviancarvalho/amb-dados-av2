...
const MenubarSubTrigger = React.forwardRef<
  HTMLDivElement, // aqui tem que ser HTMLDivElement
...
const MenubarSubContent = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<typeof MenubarPrimitive.SubContent>>(
  ({ className, ...props }, ref) => (
...
const MenubarRadioItem = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<typeof MenubarPrimitive.RadioItem>>(
